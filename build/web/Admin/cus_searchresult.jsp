                ...
                <jsp:include page="header.jsp"></jsp:include>
                    <div id="page-wrapper">
                        <div class="graphs">
                            ...
                            <button type="button" class="btn btn_5 btn-sm btn-info"><a href="customers.jsp" style="color: white">Return</a></button>
                            <br/><br/>
                        <jsp:include page="/SearchCusServlet"></jsp:include> 
                        </div>
                    </div>
                </div>
